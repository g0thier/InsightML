...
def show_collums_availables(filename, data):
    df = dataframe_pipeline(filename, data, None)
...
description = """
## InsightML : Predict any dataset with Machine Learning
 * This API autoclean columns of a dataset and auto-configure LogisticRegression and LinearRegression model for visualisation.
"""
...
app = FastAPI(
    ...
    openapi_tags= [
        {
            "name": "Home",
            "description": "🔮 InsightML API homepage."
        },
        {
            "name": "Predicts",
            "description": "🪄 InsightML API with POST or GET method."
        }
    ]
)
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>🔮 InsightML API</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="🔮 InsightML API">
  ...
  <body>
    ...
    <div class="container-narrow">
      ...
      <div class="masthead">
        ...
        <h3 class="muted">🔮 InsightML API</h3>
      </div>

      <hr>

      <div class="jumbotron">
        <h1>Project 🔮<br>InsightML API</h1>
        <p class="lead">Predict any dataset with Machine Learning. This <b>/</b> is the most simple and default endpoint. If you want to learn more, check out documentation of the api at <b>/docs</b></p>
      ...
      <div class="footer">
        <p>This is my <a href="https://apps.apple.com/fr/developer/gauthier-rammault/id1493203805">App Store page</a>, and see me there : <a href="https://www.linkedin.com/in/gauthier-rammault/">Gauthier Rammault</a>, the guy dreams to wanna be a real Data Scientist.</p>
...
@app.post("/colums_availables/", tags=["Predicts"])
async def predict_json(file: UploadFile = File(...), filename: str = ""):
    # Process with data
    list_columns = show_collums_availables(filename, file.file)
    # Format response
    response = {"Colonnes_Disponibles": list_columns}
    return response
